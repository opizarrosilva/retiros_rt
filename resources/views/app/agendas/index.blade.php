                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        @endcan @can('view', $agenda)
                                        <a
                                            href="{{ route('agendas.show', $agenda) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $agenda)
                                        <form
                                            action="{{ route('agendas.destroy', $agenda) }}"
                                            method="POST"
