                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        @can('update', $retiro)
                                        <a
                                            href="{{ route('retiros.edit', $retiro) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $retiro)
                                        <a
                                            href="{{ route('retiros.show', $retiro) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $retiro)
                                        <form
                                            action="{{ route('retiros.destroy', $retiro) }}"
                                            method="POST"
